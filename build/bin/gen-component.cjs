...
const PKG_HOME = path.join(__dirname, "../../package/gt-components/");
const SCSS_HOME = path.join(__dirname, "../../package/assets/scss");
...
fs.writeFileSync(
  path.join(__dirname, "../../package/components.json"),
