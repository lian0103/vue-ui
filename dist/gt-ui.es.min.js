import { reactive, computed, watch, resolveComponent, openBlock, createElementBlock, toDisplayString, createCommentVNode, createElementVNode, createVNode, unref, withCtx, Fragment, renderList, createBlock, normalizeClass, normalizeStyle, renderSlot, ref, getCurrentInstance, onMounted, nextTick, getCurrentScope, onScopeDispose, toRefs, withModifiers, withDirectives, vShow, h, onUpdated, createTextVNode, shallowRef, useSlots, onUnmounted, vModelDynamic, vModelText, normalizeProps, mergeProps, inject, provide } from "vue";
var TWJSON = [
  {
    districts: [
      {
...
const _sfc_main$J = /* @__PURE__ */ Object.assign(__default__$x, {
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      const _component_g_dropdown_item = resolveComponent("g-dropdown-item");
      const _component_g_dropdown = resolveComponent("g-dropdown");
      const _component_g_input = resolveComponent("g-input");
      return openBlock(), createElementBlock("div", _hoisted_1$s, [
        __props.labelText ? (openBlock(), createElementBlock("div", _hoisted_2$l, toDisplayString(__props.labelText), 1)) : createCommentVNode("", true),
        createElementVNode("div", _hoisted_3$e, [
          createElementVNode("div", _hoisted_4$9, [
            createVNode(_component_g_dropdown, {
              modelValue: valueReative.city,
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => valueReative.city = $event),
              options: unref(cityOptions)
            }, {
              default: withCtx(() => [
                (openBlock(true), createElementBlock(Fragment, null, renderList(unref(cityOptions), (item) => {
                  return openBlock(), createBlock(_component_g_dropdown_item, {
                    key: "city-" + item.label,
                    label: item.label,
                    value: item.value,
            ...
            createVNode(_component_g_dropdown, {
              ...
              options: unref(districtOptions),
              isDistrict: true
            }, {
              default: withCtx(() => [
                (openBlock(true), createElementBlock(Fragment, null, renderList(unref(districtOptions), (item) => {
                  return openBlock(), createBlock(_component_g_dropdown_item, {
          ...
          createElementVNode("div", _hoisted_5$8, [
            createVNode(_component_g_input, {
              class: "road",
...
const _hoisted_1$r = /* @__PURE__ */ createElementVNode("div", { class: "textLine" }, null, -1);
const __default__$v = {
  name: "GButton"
};
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("i", _hoisted_1$q);
}
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        unref(errorMsg) ? (openBlock(), createElementBlock("span", _hoisted_2$k, toDisplayString(unref(errorMsg)), 1)) : createCommentVNode("", true)
      ], 8, _hoisted_1$p);
    };
  }
});
    ...
    return (_ctx, _cache) => {
      ...
      return __props.label ? (openBlock(), createElementBlock("div", {
        ...
        createElementVNode("span", {
          ...
          createElementVNode("div", _hoisted_1$m, toDisplayString(__props.label), 1)
        ], 6)
...
const _hoisted_2$h = /* @__PURE__ */ createElementVNode("div", { class: "inner" }, null, -1);
const _sfc_main$s = {
  __name: "GUploadIcon",
  props: {
    percent: {
      ...
      return openBlock(), createBlock(_sfc_main$q, {
        ...
        default: withCtx(({ dropZoneActive }) => [
          createElementVNode("div", {
            ...
            withDirectives(createElementVNode("div", _hoisted_1$j, "\u62D6\u66F3\u4E0A\u50B3\u9078\u64C7\u5716\u7247", 512), [
              [vShow, !isLoading.value && !imgLoaded.value]
            ]),
            isLoading.value ? (openBlock(), createBlock(_sfc_main$s, {
              key: 0,
              class: "mr-2",
              percent: 0,
              auto: ""
            })) : createCommentVNode("", true),
            imgLoaded.value ? (openBlock(), createBlock(_sfc_main$r, {
              key: 1,
              class: "deleteIcon",
              name: "trash",
  ...
  setup(__props, { expose, emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$i, [
        unref(label) ? (openBlock(), createElementBlock("div", _hoisted_2$f, toDisplayString(unref(label)), 1)) : createCommentVNode("", true),
        createElementVNode("div", {
          class: "gt-relative",
          style: { "flex-grow": "1" },
          ...
          unref(errorMsg) ? (openBlock(), createElementBlock("div", _hoisted_5$7, toDisplayString(unref(errorMsg)), 1)) : createCommentVNode("", true),
          props.searchSelectMode ? (openBlock(), createElementBlock("div", {
            ...
            !props.selectOptions || props.selectOptions.length == 0 ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              ...
              }, toDisplayString(item.label), 9, _hoisted_6$4);
            }), 128))
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$h, [
        ...
        createElementVNode("div", _hoisted_2$e, toDisplayString(__props.modelValue), 1),
        createElementVNode("div", {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", _hoisted_1$g, [
          createElementVNode("div", {
            ...
            createElementVNode("div", _hoisted_2$d, toDisplayString(__props.headText), 1)
          ], 4),
        ...
        createElementVNode("div", _hoisted_1$f, [
          createElementVNode("div", {
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.tabs, (tab) => {
              ...
              }, toDisplayString(tab.name), 11, _hoisted_3$a);
            }), 128))
          ], 8, _hoisted_2$c)
        ]),
        createElementVNode("div", {
...
const _hoisted_2$b = /* @__PURE__ */ createElementVNode("div", { class: "gt-loadBox gt-relative" }, [
...
const _sfc_main$j = /* @__PURE__ */ Object.assign(__default__$f, {
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return gLoadingShow.value ? (openBlock(), createElementBlock("div", _hoisted_1$e, _hoisted_3$9)) : createCommentVNode("", true);
    };
  }
});
_sfc_main$j.install = function(Vue) {
          ...
          return openBlock(), createElementBlock("div", {
            ...
            createElementVNode("div", {
              ...
              createElementVNode("div", {
                ...
                !unref(collapsed) ? (openBlock(), createElementBlock("span", _hoisted_3$8, toDisplayString(item.label), 1)) : createCommentVNode("", true)
              ], 40, _hoisted_2$a),
            ...
            item.children.length > 0 && !onlyOneLevel.value ? (openBlock(), createElementBlock("div", {
              ...
              !unref(collapsed) ? (openBlock(), createElementBlock("div", _hoisted_4$6)) : createCommentVNode("", true),
...
const _sfc_main$h = /* @__PURE__ */ Object.assign(__default__$d, {
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return !isFinished.value ? (openBlock(), createElementBlock("div", _hoisted_1$c, [
        createElementVNode("div", _hoisted_2$9, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(list), (item) => {
            return openBlock(), createElementBlock("div", {
              ...
              item.msgTitle ? (openBlock(), createElementBlock("div", _hoisted_3$7, toDisplayString(item.msgTitle), 1)) : createCommentVNode("", true),
...
const _hoisted_5$4 = /* @__PURE__ */ createElementVNode("div", { class: "gt-option-suffix" }, null, -1);
const __default__$b = {
  name: "GOption"
};
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$a, [
        createElementVNode("div", _hoisted_2$7, [
          createElementVNode("div", {
            ...
            createVNode(_component_g_icon, { classes: "fas fa-angle-left" }),
            createTextVNode("\u4E0A\u4E00\u9801 ")
          ], 2),
          createElementVNode("div", _hoisted_3$5, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(pagesComputed), (num) => {
              return openBlock(), createElementBlock("div", {
                ...
                num != "pre-dot" && num != "next-dot" ? (openBlock(), createElementBlock("span", _hoisted_5$3, toDisplayString(num), 1)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
          ...
          createElementVNode("div", {
            ...
            createTextVNode(" \u4E0B\u4E00\u9801"),
            createVNode(_component_g_icon, { classes: "fas fa-angle-right" })
          ], 2)
        ])
      ]);
    };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        (openBlock(), createElementBlock("svg", _hoisted_2$6, [
          ...
          withDirectives(createElementVNode("path", _hoisted_5$2, null, 512), [
  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$8, [
        createElementVNode("span", _hoisted_2$5, toDisplayString(__props.labelName), 1),
        createElementVNode("div", {
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", _hoisted_4$2, toDisplayString(__props.statusLabel ? __props.modelValue ? "\u958B\u555F" : "\u95DC\u9589" : ""), 1)
      ], 8, _hoisted_1$7);
    };
  }
});
        ...
        createElementVNode("div", {
          ...
          createElementVNode("div", {
            ...
            createElementVNode("div", _hoisted_2$3, [
              __props.isCheckbox ? (openBlock(), createElementBlock("div", _hoisted_3$2, [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(columnsComputed), (cItem, columnIdx) => {
                ...
                return openBlock(), createElementBlock("div", {
                  ...
                  cItem.type === "selection" ? (openBlock(), createElementBlock("div", _hoisted_5$1, [
                    createVNode(_component_g_checkbox, {
                      controlMode: true,
                      type: "white",
                      checkedIcon: unref(selectionIcon),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        __props.dot ? (openBlock(), createElementBlock("div", _hoisted_1$5)) : createCommentVNode("", true),
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("div", {
          ...
          createElementVNode("div", {
            ...
            }, toDisplayString(unref(monthAll)), 9, _hoisted_2$2),
            createElementVNode("span", {
              class: "month-next",
            ...
            !isMonthAllShow.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(calenderDays), (cdStr, idx) => {
                ...
                }, toDisplayString(cdStr), 11, _hoisted_4);
              }), 128)),
...
const _hoisted_2 = /* @__PURE__ */ createElementVNode("div", { class: "inner" }, null, -1);
