...
`},"collapse-card":{show:["prop","slot"],prop:`
## \u5C6C\u6027
| \u5C6C\u6027 | \u8AAA\u660E | \u985E\u578B | \u53EF\u9078\u503C | \u9ED8\u8A8D\u503C |
| - | - | - |- | -  |
| isOpen | \u662F\u5426\u70BA\u5C55\u958B | Boolean | | false |
...
`},"collapse-card-section":{},dialog:{show:["prop"],prop:`
## \u5C6C\u6027
| \u5C6C\u6027 | \u8AAA\u660E | \u985E\u578B | \u53EF\u9078\u503C | \u9ED8\u8A8D\u503C |
| - | - | - |- | -  |
...
`},dropdownitem:{show:["prop","event"],prop:`
## \u5C6C\u6027
| \u5C6C\u6027 | \u8AAA\u660E | \u985E\u578B | \u53EF\u9078\u503C | \u9ED8\u8A8D\u503C |
| - | - | - |- | -  |
| label | String |  |  |  |
...
`},"filter-chips-group":{show:["prop"],prop:`
## \u5C6C\u6027
| \u5C6C\u6027 | \u8AAA\u660E | \u985E\u578B | \u53EF\u9078\u503C | \u9ED8\u8A8D\u503C |
| - | - | - |- | -  |
| v-model | \u9078\u9805\u503C | Boolean | | false |
...
`},input:{show:["prop","method","event"],prop:`
## \u5C6C\u6027
| \u5C6C\u6027 | \u8AAA\u660E | \u985E\u578B | \u53EF\u9078\u503C | \u9ED8\u8A8D\u503C |
| - | - | - |- | -  |
...
`},layout:{show:["prop","event","slot"],prop:`
## \u5C6C\u6027
| \u5C6C\u6027 | \u8AAA\u660E | \u985E\u578B | \u53EF\u9078\u503C | \u9ED8\u8A8D\u503C |
| - | - | - |- | -  |
...
`},"message-toast":{show:["prop","method"],prop:`
## \u5C6C\u6027
| \u5C6C\u6027 | \u8AAA\u660E | \u985E\u578B | \u53EF\u9078\u503C | \u9ED8\u8A8D\u503C |
| - | - | - |- | -  |
...
`},option:{},pagination:{show:["prop","event"],prop:`
## \u5C6C\u6027
| \u5C6C\u6027 | \u8AAA\u660E | \u985E\u578B | \u53EF\u9078\u503C | \u9ED8\u8A8D\u503C |
| - | - | - |- | -  |
...
`},switch:{show:["prop"],prop:`
## \u5C6C\u6027
| \u5C6C\u6027 | \u8AAA\u660E | \u985E\u578B | \u53EF\u9078\u503C | \u9ED8\u8A8D\u503C |
| - | - | - |- | -  |
| v-model | \u72C0\u614B\u503C | Boolean | | false |
| statusLabel | \u72C0\u614B\u6A19\u7C64 | Boolean | | false |
...
`},table:{show:["prop","method","slot"],prop:`
## \u5C6C\u6027
| \u5C6C\u6027 | \u8AAA\u660E | \u985E\u578B | \u53EF\u9078\u503C | \u9ED8\u8A8D\u503C |
| - | - | - |- | -  |
| name | \u8868\u540D\u7A31\u3002 | String |  |  |
...
`},timeline:{show:["prop"],prop:`
## \u5C6C\u6027
| \u5C6C\u6027 | \u8AAA\u660E | \u985E\u578B | \u53EF\u9078\u503C | \u9ED8\u8A8D\u503C |
| - | - | - |- | -  |
| isEnd | \u662F\u5426\u986F\u793A\u70BA\u6700\u5F8C\u7684\u6A23\u5F0F | Boolean |  |  |
...
`},timelineitem:{},title:{show:["prop"],prop:`
## \u5C6C\u6027
| \u5C6C\u6027 | \u8AAA\u660E | \u985E\u578B | \u53EF\u9078\u503C | \u9ED8\u8A8D\u503C |
| - | - | - |- | -  |
| level | \u7D1A\u8DDD | Number | 0\u30011\u30012\u30013 | 0 |
...
<template>
    <div class="w-full mx-auto mb-6 relative">
        <g-title :level="2" class="mb-3">with slot dropdownItem</g-title>
        <g-dropdown class="mr-4" v-model="inputs.dropdown0">
            <g-dropdown-item
