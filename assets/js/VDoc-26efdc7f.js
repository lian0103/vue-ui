import{aH as s,az as m,_ as i,$ as t,a6 as n,b1 as c,a5 as l}from"./@vue-2b1be6ab.js";const _={class:"pb-8 flex justify-center items-center flex-col"},g={class:"paragraphHead",id:"dev"},d=t("div",{class:"mb-8 w-full md:w-3/4 mx-auto"},[t("p",null,"- Vue3\u5C08\u6848")],-1),u={class:"mb-8 w-full md:w-3/4 mx-auto"},x={__name:"VDoc",setup(f){const e=`
# @greattree/front-ui
...
> 2022.10.06 \u66F4\u65B0
`;return(v,r)=>{const o=s("g-title"),p=s("v-md-editor");return m(),i("div",_,[t("div",g,[n(o,{level:1,class:"mb-4"},{default:c(()=>[l("\u652F\u63F4")]),_:1})]),d,t("div",u,[n(p,{modelValue:e,"onUpdate:modelValue":r[0]||(r[0]=a=>e=a),mode:"preview"})])])}}};export{x as default};
